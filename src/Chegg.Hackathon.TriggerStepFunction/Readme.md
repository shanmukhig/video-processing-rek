...
Execute unit tests
```
    cd "Chegg.Hackathon.TriggerStepFunction/test/Chegg.Hackathon.TriggerStepFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Chegg.Hackathon.TriggerStepFunction/src/Chegg.Hackathon.TriggerStepFunction"
